...
public class RequestsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RequestsFragmentsView = inflater.inflate(R.layout.fragment_requests, container, false);
        ...
        myRequestsList = (RecyclerView)RequestsFragmentsView.findViewById(R.id.chat_requests_list);
                                ...
                                UsersRef.child(list_user_id).addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        if (dataSnapshot.hasChild("image")) {
                                            ...
                                            Picasso.get().load(requestProfileImage).placeholder(R.drawable.profile_image).into(holder.userProfileImage);
                                        }
